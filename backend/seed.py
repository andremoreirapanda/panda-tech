...
def main():
    ...
    for codigo, nome, preco, lim_pac, lim_prof, recursos, cor, ordem in planos_data:
        conn.execute(
            """INSERT INTO planos (codigo, nome, preco_mensal_centavos, limite_pacientes, limite_profissionais, recursos_json, cor, ordem)
               VALUES (?, ?, ?, ?, ?, ?, ?, ?)""",
