...
// Pandoo (25/09/2026): "/novo" antes de "/:id" (o router usa a primeira que casa).
rota("/gestor/pandoo", ["gestor"], (app) => viewPandoo(app));
rota("/gestor/pandoo/novo", ["gestor"], (app) => viewPandooEditor(app, {}));
rota("/gestor/pandoo/:id", ["gestor"], (app, p) => viewPandooEditor(app, p));
...
rota("/profissional/pandoo/novo", ["profissional"], (app) => viewPandooEditor(app, {}));
rota("/profissional/pandoo/:id", ["profissional"], (app, p) => viewPandooEditor(app, p));
